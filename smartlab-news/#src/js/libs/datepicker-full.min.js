  ...
  return function (e) {
    ...
    function h(e, t, n) {
      var a = t.currentMonth,
        ...
        b = +y.end,
        D = new Date,
        q = r === D.getFullYear() && a === D.getMonth(),
        S = g(new Date(e).setDate(1)),
        w = S.getDay() - f,
        M = w < 0 ? 7 : 0;
      ...
      for (var P = 1; P <= C; P++) {
        var j = (P - 1) % 7,
          ...
          N = m[+O],
          E = "qs-num",
          I = '<span class="qs-num">' + O.getDate() + "</span>",
          A = p && b && +O >= p && +O <= b;
        Y < 1 || Y > x ? (E = "qs-empty qs-outside-current-month", l ? (N && (E += " qs-event"), E += " qs-disabled") : I = "") : ((o && O < o || s && O > s || u(O) || d.some((function (e) {
          return e === +O
        })) || h && v.some((function (e) {
          return e === j
        }))) && (E = "qs-disabled"), N && (E += " qs-event"), q && Y === D.getDate() && (E += " qs-current"), +O == +i && (E += " qs-active"), A && (E += " qs-range-date-" + j, p !== b && (E += +O === p ? " qs-range-date-start qs-active" : +O === b ? " qs-range-date-end qs-active" : " qs-range-date-middle"))), L.push('<div class="qs-square ' + E + " " + k + '">' + I + "</div>")
      }
    ...
    function v(e, t, n) {
      var a = t.el,
        ...
        i = e.textContent,
        s = t.sibling;
      (a.disabled || a.readOnly) && t.respectDisabledReadOnly || (t.dateSelected = n ? void 0 : new Date(t.currentYear, t.currentMonth, i), r && r.classList.remove("qs-active"), n || e.classList.add("qs-active"), y(a, t, n), n || q(t), s && (m({
        instance: t,
        deselect: n
    ...
    function M(e, t, n, a) {
      var r = isNaN(+(new Date).setFullYear(t.value || void 0)),
        i = r ? null : t.value;
      if (13 === (e.which || e.keyCode) || "click" === e.type) a ? p(null, n, i, a) : r || t.classList.contains("qs-disabled") || p(null, n, i, a);
      ...
      if (!(i && i.isMobile && i.disableMobile))
        if ("click" === t) {
          ...
          var o = i.calendar,
            ...
            c = i.disableYearOverlay,
            d = i.nonInput,
            u = o.querySelector(".qs-overlay-year"),
            h = !!o.querySelector(".qs-hidden"),
            f = o.querySelector(".qs-month-year").contains(n),
            m = n.dataset.monthNum;
          if (i.noPosition && !s) (l.classList.contains("qs-hidden") ? S : q)(i);
          else if (r.contains("qs-arrow")) p(r, i);
          else if (f || r.contains("qs-close")) c || w(!h, i);
          else if (m) M(e, u, i, m);
          else {
          ...
          var D = i.calendar.querySelector(".qs-submit"),
            g = n.value.split("").reduce((function (e, t) {
    ...
    function P(e, t) {
      ...
      return this.dateSelected = n, t && (this.currentYear = n.getFullYear(), this.currentMonth = n.getMonth(), this.currentMonthName = this.months[n.getMonth()]), y(this.el, this), i && (m({
        instance: this
    ...
    function Y(e, t, n) {
      ...
      if (null == t) e[u()] = void 0, i ? (i[u()] = void 0, n ? (r && !a || !r && !i.dateSelected) && (e.minDate = void 0, i.minDate = void 0) : (r && !i.dateSelected || !r && !a) && (e.maxDate = void 0, i.maxDate = void 0)) : e[h()] = void 0;
      else {
    ...
    e.exports = function (e, t) {
      ...
      var n = function (e, t) {
        ...
        var l = function (e, t) {
          ...
          d = n === document.body,
          u = d ? document.body : n.parentElement,
        ...
        if (l.sibling) {
          var m = l.sibling,
            p = v,
            b = m.minDate || p.minDate,
            q = m.maxDate || p.maxDate;
          p.sibling = m, m.sibling = p, m.minDate = b, m.maxDate = q, p.minDate = b, p.maxDate = q, m.originalMinDate = b, m.originalMaxDate = q, p.originalMinDate = b, p.originalMaxDate = q, m.getRange = O, p.getRange = O
        }
