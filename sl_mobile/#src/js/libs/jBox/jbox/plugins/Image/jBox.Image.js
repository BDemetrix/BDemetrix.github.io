...
jQuery(document).ready(function () {
  ...
  new jBox.plugin('Image', {
    ...
    _onInit: function ()
    {
      ...
      var appendImage = function (gallery, id, preload, open, error, width, height)
      {
      ...
      this.checkSize = function(img)
      {
        if ((this.content.width() <= img.data('width')) || (this.content.height() <= img.data('height')))
        {
      ...
      this.showImage = function (img)
      {
        ...
        if (jQuery('#jBox-image-' + gallery + '-' + id).length) {
          ...
          this.checkSize(jQuery('#jBox-image-' + gallery + '-' + id));
        ...
        // Load image
          ...
          jQuery('<img src="' + this.images[gallery][id].src + '"/>').each(function ()
          {
            ...
            {
              appendImage(gallery, id, false, null, false, tmpImg.width, tmpImg.height);
              this.checkSize(jQuery('#jBox-image-' + gallery + '-' + id));
              showLabel(gallery, id);
            ...
            tmpImg.onerror = function () {
              appendImage(gallery, id, false, null, true, tmpImg.width, tmpImg.height);
              showLabel(gallery, id);
              this.wrapper.removeClass('jBox-image-loading');
            }.bind(this);
        ...
        if (this.images[gallery].length > 1)
        {
          ...
          (!jQuery('#jBox-image-' + gallery + '-' + next_id).length) && jQuery('<img src="' + this.images[gallery][next_id].src + '"/>').each(function ()
          {
            ...
            tmpImg.onload = function ()
            {
                appendImage(gallery, next_id, true, null, false, tmpImg.width, tmpImg.height);
            }.bind(this);
            
            tmpImg.onerror = function ()
            {
              appendImage(gallery, next_id, true, null, true, tmpImg.width, tmpImg.height);
            }.bind(this);
