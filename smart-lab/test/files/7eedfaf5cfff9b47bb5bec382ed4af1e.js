// Automatic generation on 2021-05-05 08:35:00
...
var e=this.options.urlAppendParams.version;if(parseFloat(e)>parseFloat(l)){this.sendMessage("halt","refresh",false);if(parseFloat(l)<2.4){var k={"pm.userId":true,"pm.lastUpdate":true};
for(var g in localStorage){if(!(g in k)){delete localStorage[g];}}}localStorage["pm.version"]=e;}else{if(parseFloat(e)<parseFloat(l)){this.halt("unknown","client");
